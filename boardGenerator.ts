...
class Board {
  ...
  constructor(properties: BoardProperties) {
    ...
    this.size = shopAmount + twoTruthsOneLieAmount + minesAmount + monsterBattlesAmount + playerBattlesAmount +
      negativeEffectsAmount + randomEffectsAmount + positiveEffectsAmount;
    ...
    for (let i = 0; i < this.size - 1; i++) {
      ...
      const shouldGenerateBranch = i > 11 && branchesLeft > 0 && getRandomInteger(0, 10) >= 8 && i + (properties.maxBranchSize * 2) < this.size - 1;
